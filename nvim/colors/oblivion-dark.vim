...
" Default colors
"set background=dark
let s:bg = { 'gui': '#23272d', 'cterm': 'none' }
...
let s:red = { 'gui': '#f1756c', 'cterm': 203 }
let s:orange = { 'gui': '#f3b57e', 'cterm': 209 }
let s:yellow = { 'gui': '#c3c170', 'cterm': 11 }
let s:green = { 'gui': '#72b26d', 'cterm': 2 } " 186 –– almost perfect match
let s:cyan = { 'gui': '#80d2b6', 'cterm': 117 }
let s:blue = { 'gui': '#999cce', 'cterm': 111 }
let s:paleblue = { 'gui': '#b2ccd6', 'cterm': 152 }
let s:purple = { 'gui': '#d5a4d0', 'cterm': 176 }
let s:brown = { 'gui': '#c9a475', 'cterm': 137 }
let s:pink = { 'gui': '#e19bdd', 'cterm': 204 }
let s:violet = { 'gui': '#cb9dce', 'cterm': 139 }
